...
function BookCar() {
  ...
  const carImages = {
    "Audi A1 S-Line": "https://images.unsplash.com/photo-1549399736-e91a75acb95a?w=300&h=200&fit=crop",
    "VW Golf 6": "https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=300&h=200&fit=crop",
    "Toyota Camry": "https://images.unsplash.com/photo-1590362891991-f776e747a588?w=300&h=200&fit=crop",
    "BMW 320 ModernLine": "https://images.unsplash.com/photo-1555215695-3004980ad54e?w=300&h=200&fit=crop",
    "Mercedes-Benz GLK": "https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=300&h=200&fit=crop",
    "VW Passat CC": "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=300&h=200&fit=crop"
  };
  ...
  return (
    <>
      <section id="booking-section" className="relative py-16 bg-gradient-to-br from-gray-50 to-gray-100">
        {/* Success Message */}
        {showSuccess && (
          <div className="fixed top-4 right-4 z-50 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 animate-pulse">
            ...
            <button onClick={() => setShowSuccess(false)} className="ml-2 hover:bg-green-600 rounded px-2 py-1">×</button>
          </div>
        )}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-10">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">Book Your Perfect Car</h2>
              <p className="text-gray-600 text-lg">Find the best deals on car rentals with our premium fleet</p>
            </div>
          ...
          <div className="bg-white w-full max-w-6xl mx-auto rounded-2xl overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-6 flex justify-between items-center">
              <div>
                ...
                <p className="text-red-100 mt-1">Just a few more details to get your car ready</p>
              </div>
              <button
            ...
            <div className="p-8">
              ...
              <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900 mb-2">Upon completing this reservation, you will receive:</h4>
                    <p className="text-blue-800">Your rental voucher to produce on arrival at the rental desk and a toll-free customer support number.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 mb-8">
                {/* Booking Details */}
                <div className="space-y-6">
                  <h3 className="text-xl font-semibold text-gray-800 border-b pb-2">Booking Summary</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{pickUp} • {pickTime}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        <h6 className="font-semibold text-gray-800">Drop-Off</h6>
                        <p className="text-sm text-gray-600">{dropOff} • {dropTime}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 text-center">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Your Selected Car</h3>
                  <h5 className="text-lg font-medium text-red-600 mb-4">{carType}</h5>
                  {imgUrl && (
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-6">
                  ...
                  {/* Address */}
                  <div>
                    <label className="block font-medium text-gray-700 mb-2">Street Address *</label>
                    <input
                      value={address}
                  ...
                  <div className="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    />
                    <label className="text-gray-700">Please send me latest news and updates</label>
                  </div>
